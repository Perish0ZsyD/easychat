  ...
  <Layout>
    <template #left-content>
      ...
      <div class="top-search">
        <el-input v-moldel="searchKey" clearable placeholder="搜索" size="small" @keyup="search">
          <template #suffix>
        ...
        <tempplate v-for="part in partList">
          ...
          <div class="part-list">
            ...
            <template v-for="contact in part.contactData">
              ...
              >
                <Avatar :user-id="contact[part.contactId]" :width="35"></Avatar>
                <div class="text">
